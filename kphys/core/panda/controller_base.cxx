...
TypeHandle BaseControllerNode::_type_handle;

/**
 *
 */
BaseControllerNode::
BaseControllerNode(BulletShape *shape, PN_stdfloat step_height, const char *name) : BulletBaseCharacterControllerNode(name) {
 ...
 *
 */
BulletShape *BaseControllerNode::
get_shape() const {
 ...
 *
 */
PN_stdfloat BaseControllerNode::
get_max_slope() const {
  LightMutexHolder holder(BulletWorld::get_global_lock());
